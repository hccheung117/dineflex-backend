...
export class InitTables1741904533055 implements MigrationInterface {
    name = 'InitTables1741904533055'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "restaurant" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "location" "public"."restaurant_location_enum" NOT NULL, "cuisine" character varying NOT NULL, "phone" character varying NOT NULL, "hasEarlyBird" boolean NOT NULL DEFAULT false, "hasLastMinute" boolean NOT NULL DEFAULT false, "thumbnailUrl" character varying NOT NULL, CONSTRAINT "PK_649e250d8b8165cb406d99aa30f" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "user" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "email" character varying NOT NULL, "password" character varying NOT NULL, "salt" character varying NOT NULL, "role" "public"."user_role_enum" NOT NULL DEFAULT 'CUSTOMER', CONSTRAINT "UQ_e12875dfb3b1d92d7d7c5377e22" UNIQUE ("email"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
